...
def main():
    ...
    debug, show_plot, write_result_to_file, query_only, file_name  = check_usage() # O(1)
    ...
    run_algorithm(point, line_segments, show_plot, write_result_to_file, query_only, debug) # O_E(n log(n))
